...
(submission under review). Publication does not bundle the resource into the
plugin ZIP or guarantee availability in every account.
...
- `main.ts` SHA-256: `226ba4f0ebdaf86e2dbe9be8897761ca4310679295b3a781e8e84598bed8564c`
