...
const english = {
  ...
  nativeUnavailable: "Editable output requires a supported Frame and a configured perspective effect in this file.",
  nativePreparing: "Preparing editable output…",
  nativeEffectUnavailable: "Add Worldbend Perspective from Tools. If it is already added, close and reopen this file, then open Worldbend again.",
...
const simplifiedChinese: Record<MessageKey, string> = {
  ...
  nativeUnavailable: "可编辑输出需要受支持的 Frame，并且当前文件已配置透视效果。",
  nativePreparing: "正在准备可编辑输出…",
  nativeEffectUnavailable: "请在工具中添加 Worldbend Perspective。若已添加，请关闭并重新打开此文件，再打开 Worldbend。",
