...
const english = {
  ...
  surfaceBrushLimit: "Brush capacity is reached. Release to finish this stroke. Undo an earlier stroke to add more.",
...
const simplifiedChinese: Record<MessageKey, string> = {
  ...
  surfaceBrushLimit: "已达到笔刷容量上限。松手可完成当前笔画；如需继续添加，请撤销较早的笔画。",
