...
const english = {
  ...
  surfaceSplitRequired: "These curves need their current splits. Undo the handle edits before removing a split.",
  surfacePinDensity: "This mesh size would move a pin. Unpin it before changing the mesh size.",
  surfacePinLimit: "The 64-pin limit is reached. Unpin an existing point before adding another.",
  surfaceStrokeLimit: "The 64-stroke limit is reached. Undo an earlier stroke to continue.",
  surfaceBrushLimit: "Brush capacity is reached. Undo an earlier stroke to add more.",
  surfaceStrokeSampleLimit: "This stroke reached its sample limit. Release to finish it, then continue with a new stroke.",
  surfacePinLabel: "Pin {x}, {y} to its original source position. Activate to toggle.",
  copyCss: "Copy CSS",
  cssCopied: "CSS transform copied.",
  cssCopyFailed: "The CSS transform could not be copied. Try again.",
  cssWarpUnsupported: "CSS cannot represent Warp, Mesh, or Split Warp. Use an HD image.",
  templateMesh: "Mesh",
  templateSurface: "Split Warp",
...
const simplifiedChinese: Record<MessageKey, string> = {
  ...
  surfaceRadius: "半径",
  surfaceStrength: "强度",
  surfaceSplitRequired: "当前曲线需要保留这些拆分。请先撤销手柄编辑，再移除拆分。",
  surfacePinDensity: "这个网格尺寸会移动固定点。请先解除固定，再更改网格尺寸。",
  surfacePinLimit: "已达到 64 个固定点的上限。请先解除一个现有固定点，再添加新固定点。",
  surfaceStrokeLimit: "已达到 64 条笔画的上限。请撤销较早的笔画后继续。",
  surfaceBrushLimit: "已达到笔刷总容量上限。请撤销较早的笔画后继续。",
  surfaceStrokeSampleLimit: "当前笔画已达到采样上限。松手完成本笔画，即可开始新笔画。",
  surfacePinLabel: "将 {x}, {y} 固定在源图原位置。点击或按回车切换。",
  copyCss: "复制 CSS",
  cssCopied: "已复制 CSS 变换。",
  cssCopyFailed: "CSS 变换复制失败，请重试。",
  cssWarpUnsupported: "CSS 无法表示弯曲、网格或拆分弯曲。请使用高清图像。",
  templateMesh: "网格变形",
  templateSurface: "拆分弯曲",
  mockupTitle: "平面合成",
  mockupOpacity: "不透明度",
  mockupGrid: "网格",
  mockupColumns: "列",
