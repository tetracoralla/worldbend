...
const english = {
  ...
  openCanvas: "Canvas variants…",
  canvasBack: "Back",
  canvasTitle: "Canvas variants",
  ...
  invalidCanvas: "Use 1–8 unique sizes from 1 to 4096 px within the 32 Mi-pixel total limit.",
  language: "Language",
  ...
  canvasApplied: "Canvas variants applied.",
...
const simplifiedChinese: Record<MessageKey, string> = {
  ...
  invalidCanvas: "请使用 1–8 个 1 至 4096 px 的唯一尺寸，并将总像素控制在 32 Mi 以内。",
  language: "语言",
  languageSystem: "跟随系统",
