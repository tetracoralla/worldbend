...
export function createRemapWorkspace(input: {
  ...
  shell.inspector.innerHTML = `<label class="designer-field"><span data-role="mode-label"></span><select data-role="mode"><option value="lens"></option><option value="displacement"></option></select></label>
    ...
    <div data-role="lens"><div class="designer-row"><label class="designer-field"><span data-role="k1-label"></span><input data-role="k1" type="number" min="-4" max="4" step="0.01"></label><label class="designer-field"><span data-role="k2-label"></span><input data-role="k2" type="number" min="-4" max="4" step="0.01"></label></div><button data-role="more" type="button" aria-expanded="false"></button><div data-role="advanced" hidden></div></div>
  ...
  return {
    ...
    updateLocale() {
      ...
      controls["more"]!.textContent = copy.more;
